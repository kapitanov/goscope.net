...
if (props.enable) {
  const storedValue =
    (process.client && localStorage.getItem('gdpr-consent')) || null;
  if (storedValue !== null) {
    ...
    <template v-if="show">
      ...
      >
        <div class="grow flex flex-col">
          ...
          <p>
            We use our own cookies and third-party cookies so that we can
            display this website correctly and better understand how this
            website is used, with a view to improving the services we offer.
          </p>
        </div>
