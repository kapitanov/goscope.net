// Healthy application sample - normal HTTP server with a few goroutines
export const healthyExample = `
goroutine 1 [IO wait]:
...
main.main()
	/Users/username/projects/healthy-app/main.go:15 +0x48
...
created by net/http.(*connReader).startBackgroundRead in goroutine 4
	/opt/homebrew/Cellar/go/1.21.5/libexec/src/net/http/server.go:679 +0xc8
`.trim();

// High concurrency sample - many goroutines in different states
...
main.main()
	/Users/username/projects/high-concurrency/main.go:25 +0x124

goroutine 2 [running]:
runtime.gcBgMarkWorker()
	/opt/homebrew/Cellar/go/1.21.5/libexec/src/runtime/mgc.go:1366 +0xe4
runtime.goexit()
	/opt/homebrew/Cellar/go/1.21.5/libexec/src/runtime/asm_arm64.s:1197 +0x4
...
main.worker(0x2, 0x1400009e060)
	/Users/username/projects/high-concurrency/main.go:45 +0x80
created by main.main in goroutine 1
	/Users/username/projects/high-concurrency/main.go:23 +0x100

goroutine 19 [runnable]:
main.worker(0x3, 0x1400009e060)
	/Users/username/projects/high-concurrency/main.go:45 +0x80
created by main.main in goroutine 1
	/Users/username/projects/high-concurrency/main.go:23 +0x100
...
main.consumer()
	/Users/username/projects/high-concurrency/main.go:52 +0x28
created by main.main in goroutine 1
	/Users/username/projects/high-concurrency/main.go:24 +0x11c

goroutine 21 [chan send]:
main.producer(0x1400009e060)
	/Users/username/projects/high-concurrency/main.go:58 +0x48
created by main.main in goroutine 1
	/Users/username/projects/high-concurrency/main.go:25 +0x138
`.trim();

// Blocking operations sample - goroutines waiting on various synchronization primitives
...
// Comprehensive demo example - shows various sync primitives and states
...
// Default example (backwards compatibility)
export const example = demoExample;
