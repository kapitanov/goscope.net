...
function copyMarkdownHandler() { copyHandler((data) => asMarkdown(data)); }
function copyPlainTextHandler() { copyHandler((data) => asText(data)); }
function copyCommentTextHandler() { copyHandler((data) => wrapIntoComments(asText(data))); }

const activeTab = ref('table');
const selectActiveTab = (tab: string) => { activeTab.value = tab; };
</script>
