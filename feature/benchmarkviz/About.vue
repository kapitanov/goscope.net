...
<template>
  ...
  <div v-if="isExpanded" class="mt-4 px-4 rounded border border-gray-500">
    ...
    <div class="py-4">
      <p>Golang offers a built-in benchmarking framework as a part of <CodeInline>testing</CodeInline> package.</p>

      <p>For instance, try running the following test file:</p>

      <CodeBlock :code="exampleSourceCode" />

      <p>Save this file as <CodeInline>benchmark_test.go</CodeInline>, then run it with <CodeInline>go run -bench=.</CodeInline> command:</p>
