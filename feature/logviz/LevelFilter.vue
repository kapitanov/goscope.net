...
import LevelFilterModal from './LevelFilterModal.vue';
...
<template>
  <div :class="combineClasses('inline-block', 'relative', props.class)">
    <Hotkey hotkey="KeyL" @pressed="showModal" />
  ...
  <div v-if="isModalOpen" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <LevelFilterModal :data="props.data" :selected="model" @select="onSelect" @close="closeModal" />
  </div>
</template>
